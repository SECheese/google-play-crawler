...
urls = ["https://play.google.com/store/apps/details?id=air.com.doubleflawless.StressBaal",
...
for url in urls:
    ...
    for expand_page in expand_pages:
        print("Author Name: ", str(expand_page.find("span", class_="author-name").string).translate(non_bmp_map))
